...
export default function ProblemsSection() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-red-50/30 to-gray-50 py-16 px-6 md:py-24 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            If you're nodding "yes" to <span className="font-semibold text-gray-800">even ONE</span> of these, 
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-5xl mx-auto mb-12">
          {problems.map((problem, index) => (
            <div
              key={index}
              className="group relative bg-white rounded-2xl p-6 shadow-sm border border-gray-200
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 md:p-10 
                        shadow-2xl border border-gray-700 relative overflow-hidden">
            {/* Accent gradient */}
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-6 leading-relaxed max-w-2xl mx-auto">
              ...
              {/* Mini stats */}
              <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto pt-6 border-t border-gray-700">
                <div>
                  <div className="text-3xl font-bold text-red-400 mb-1">3 sec</div>
                  <div className="text-sm text-gray-400">Load time target</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">To update content</div>
                </div>
              </div>
            </div>
          </div>
