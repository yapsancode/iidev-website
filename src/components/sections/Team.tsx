      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
            ...
            <div className="relative z-10">
                <img 
                    src="https://picsum.photos/id/91/150/150" 
                    alt="Founder 2" 
                    className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white shadow-lg object-cover"
                />
                 <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white px-3 py-1 rounded-full shadow-sm border border-neutral-100 text-xs font-bold whitespace-nowrap">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-6">
          Just two senior developers who actually care. <br className="hidden md:block"/> No middlemen.
        </h2>
        
        <p className="text-lg text-neutral-500 leading-relaxed">
          When you hire agencies, you pay for the overhead, the sales team, and the office snacks. 
          When you hire <span className="text-neutral-900 font-semibold">iidev studio</span>, 
