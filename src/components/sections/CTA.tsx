...
const CTA: React.FC<CTAProps> = ({ onBookingClick }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-emerald-500 text-white text-lg font-semibold px-8 py-4 rounded-full shadow-lg shadow-emerald-900/20 hover:bg-emerald-400 hover:scale-105 transition-all duration-300 active:scale-95"
          >
            <Calendar size={20} />
            Book Your Free Call
          </button>
